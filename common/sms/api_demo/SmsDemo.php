<?php
namespace common\sms\api_demo;
ini_set("display_errors", "on");

require_once dirname(__DIR__) . '/api_sdk/vendor/autoload.php';
//// use backend\common\sms\api
...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIoMtLFeTIU1us"; // AccessKeyId

        $accessKeySecret = "knGrfZBDC7YwDfgiW8079wN0TdWqGd"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($phone,$msgcode,$code) {
